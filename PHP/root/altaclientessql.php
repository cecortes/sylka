...
<BODY BGCOLOR="#F7F8E0">
	...
	$rap = $_POST['rap'];
	$clave = $_POST['clave'];
	$lista = $_POST['listaprecios'];
	
	//Insertamos los valores en MYSQL
	$sql = mysql_query("INSERT INTO clientes(rap,nombre,clave,listaprecios) VALUES ('$rap','$nombre','$clave','$lista');");
	...
	mysql_close();
	echo '<div style="text-align:left"><div style="font-size:35px;">Los datos del cliente han sido actualizados en la base de datos</div></div>';
	?>
	<hr />
</body>
</html>
