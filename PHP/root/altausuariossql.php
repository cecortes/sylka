...
<BODY BGCOLOR="#F7F8E0">
	...
	$sql = mysql_query("INSERT INTO usuarios(idusuario,usuario,password,nombre,clave,direccion,telefono,correo,ruta) VALUES ('$idusuario','$usuario','$password','$nombre','$clave','$direccion','$telefono','$correo','$ruta');");
