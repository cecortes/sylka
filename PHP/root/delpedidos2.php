...
<BODY BGCOLOR="#F7F8E0">
	...
	<hr />
	<form action="delpedidos2.php" method="post"> 
	<p>Escriba el IDPEDIDO de Inicio: <input type="text" name="minId" value="" size="2"></p>
	<p>Escriba el IDPEDIDO Final: <input type="text" name="maxId" value="" size="2"></p>
	...
	{
		//Capturamos el idpedido inicial y final
		$minPedido = $_POST['minId'];
		$maxPedido = $_POST['maxId'];
		
		//Generamos el query para borrar la clave
		$queryBorrar = mysql_query("DELETE FROM pedidos WHERE idpedido>= '$minPedido' AND idpedido<= '$maxPedido';");
